...
## Summary
So is Azure DevOps "dead"? No, of course not. But I hope you have at least understand where I'm coming from. A vast amount of features are missing from Azure DevOps and, looking at their [lean list of things](https://learn.microsoft.com/en-us/azure/devops/release-notes/features-timeline) shipped in the last few years, likely never coming. Since using them in my daily work, I consider them to be vital tools to do _more with less_.
