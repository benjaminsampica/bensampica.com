...
links:
  - type: code
    url: https://github.com/benjaminsampica/bensampica.com/tree/main/src/content/blog/minimalapihtmx
featured: true
draft: false
toc: true
---
...
> [!NOTE]
> Want to just see the code? [Click here!](https://github.com/benjaminsampica/bensampica.com/tree/main/src/content/blog/minimalapihtmx)
...
![Home sweet home.](images/the-first-page.png)
...
![The counter page.](images/counter-page.png)
...
![Counting increments by one when clicked using server side rendering.](images/raw-html.png)
...
![A happy failure message.](images/validation-message.png)
...
![Success!](images/success-message.png)
...
![The empty weather page.](images/forecast-base.png)
...
![Loading the weather.](images/forecast-loading.png)
...
![The table with paging.](images/forecast-complete.png)
...
![An expected 404 page.](images/error-handling.png)
