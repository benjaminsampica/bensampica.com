...
## Summary
So is Azure DevOps "dead"? No, of course not. But I hope you have a least seen what I have - a vast amount of features missing from Azure DevOps. Since using them in my daily work, I consider them to be vital tools to do _more with less_.
